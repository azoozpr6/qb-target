...
-------------------------------------------------------------------- Target ----------------------------------------------------------------------------
	...
	RegisterNetEvent('qb-ui:Banking', function()
		TriggerEvent('qb-ui:sendMenu', {
			{
				id = 1,
				header = "Bank",
				txt = ""
			...
			{
				id = 3,
				header = "Manage Bank Account",
				txt = "You can open a shared bank account for your organization",
				params = {
...
-- RegisterNetEvent('qb-ui:opendress', function()
--     TriggerEvent('qb-ui:sendMenu', {
--         {
--             id = 1,
...
-- RegisterNetEvent('qb-ui:opendress2', function(data)
--     local id = data.id
...
--             txt = "",
--             params = {
--                 event = "qb-ui:testMenu"
--             }
--         },
--         {
--             id = 2,
--             header = "Buy Dress",
--             txt = "You can Check our Collections",
-- 			params = {
--                 event = "clothing:interact",
-- 				args = "clothesmenu"
-- 			}
...
-- exports['qb-target']:AddTargetModel(`s_f_m_fembarber`, {
--     options = {
--         { 
--             event = "clothing:interact", 
--             icon = "fas fa-cut", 
--             label = "Speak with Barber Employee",
...
-- 				TriggerEvent('clothing:interact', 'barbermenu') -- Triggers a client event called testing:event and sends the argument 'test' with it
-- 			end,	   
-- 		},
--     },
--     distance = 3.0 
...
-- exports['qb-target']:AddTargetModel(`u_m_y_tattoo_01`, {
--     options = {
--         { 
--             event = "clothing:interact", 
--             icon = "fas fa-cut", 
--             label = "Speak with Tattos Employee",
-- 			action = function(entity) -- This is the action it has to perform, this REPLACES the event and this is OPTIONAL
-- 				if IsPedAPlayer(entity) then return false end -- This will return false if the entity interacted with is a player and otherwise returns true
-- 				TriggerEvent('clothing:interact', 'tattoomenu') -- Triggers a client event called testing:event and sends the argument 'test' with it
-- 			end,	   
-- 		},
--     },
--     distance = 3.0 
...
-- RegisterNetEvent('qb-ui:shopmenu', function()
-- 	TriggerEvent('qb-ui:sendMenu', {
-- 		{
-- 			id = 1,
...
-- 			id = 2,
-- 			header = "Open Shop",
-- 			txt = "This Menu is used to Shoping",
-- 			params = {
...
-- 	end)
	...
	RegisterNetEvent('qb-ui:liquorshop', function()
		TriggerEvent('qb-ui:sendMenu', {
			{
				id = 1,
				header = "Liqour Shop",
...
RegisterNetEvent('qb-ui:shopmenu2', function()
	TriggerEvent('qb-ui:sendMenu', {
		{
			id = 1,
...
RegisterNetEvent('qb-ui:shopmenu3', function()
	TriggerEvent('qb-ui:sendMenu', {
		{
			id = 1,
...
exports['qb-target']:AddTargetModel(`cs_omega`, {
	options = {
        { 
            event = "qb-shops:marketshop", 
            icon = "fas fa-shopping-cart",  
            label = "Speak with drug dealer", 
        },
	},
	distance = 2.0 
})
...
exports['qb-target']:AddTargetModel(`a_m_y_genstreet_01`, {
	options = {
        { 
            event = "qb-shops:marketshop", 
            icon = "fas fa-shopping-cart",  
            label = "Speak with hackers phone dealer", 
        },
	},
	distance = 2.0 
})
...
exports['qb-target']:AddTargetModel(`a_m_o_genstreet_01`, {
	options = {
        { 
            event = "qb-shops:marketshop", 
            icon = "fas fa-shopping-cart",  
            label = "Speak with the cameras seller", 
        },
	},
	distance = 2.0 
})
...
exports['qb-target']:AddTargetModel(`a_f_y_eastsa_03`, {
    options = {
            {
                    event = "qb-ui:petshop",
                    icon = "fas fa-shopping-cart",
                    label = "Talk With Pet Seller"
        },
    },
    distance = 4.0 
})
...
-- Pillbox NH
RegisterNetEvent('qb-ui:pillbox', function()
    TriggerEvent('qb-ui:sendMenu', {
        {
            id = 1,
...
-- Pillbox NH
-- RegisterNetEvent('qb-ui:petshop', function()
--     TriggerEvent('qb-ui:sendMenu', {
--         {
--             id = 1,
--             header = "Pillbox Hill Medical Center",
...
--         {
--             id = 2,
--             header = "Talk with Pet Seller",
--             txt = "Want to buy a pet?",
--             params = {
--                 event = "qb-shops:marketshop",
--                 args = {
--                     number = 1,
...
RegisterNetEvent('qb-ui:carwash', function()
	TriggerEvent('qb-ui:sendMenu', {
		{
			id = 1,
		...
		},
		{
			id = 2,
			header = "wash car",
			txt = "This Menu is used to washing",
			params = {
...
-- RegisterNetEvent('qb-ui:cityhall', function()
-- 	TriggerEvent('qb-ui:sendMenu', {
-- 		{
-- 			id = 1,
-- 			header = "LIFE INVADER",
...
--------------- police Garage
		...
		RegisterNetEvent('qb-ui:policegarage', function()
			TriggerEvent('qb-ui:sendMenu', {
				{
					id = 1,
